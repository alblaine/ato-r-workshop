...
* The basics of RStudio and why it’s useful for creating documents using R
* How to create documents of multiple types
* R packages knitr, pandoc and rmarkdown
* Basics of R Markdown
* The structure of an R Markdown file
* How to embed R code into documents
* How to convert files into different types
* Chunk commands
...
* [rmarkdown](https://github.com/rstudio/rmarkdown) - R package that converts R Markdown documents into a variety of formats. Based on pandoc. Already included with RStudio.
...
An R Markdown file is just a text file saved as .Rmd. 
...
This short exercise is to familiarize you with the basics of Markdown. 
...
* [rticles](https://github.com/rstudio/rticles) is an LaTeX academic journal R package. 

To use a template, you must install the template package: 
...
* You can add a CSS (Cascading Style Sheet) file to your project if you want to change the styling of your Slide presentation. 
...
## Creating an interactive web application with Shiny

Shiny is an R framework for creating interactive web applications.

Shiny applications are usually two files 
